...
export const RegistreerDeelnemerByCardModal: React.FC<
  RegistreerDeelnemerByCardFilterModalProps
> = ({ dismissModal }) => {
          ...
          <IonItem>
            <IonText style={{ margin: '10px 0' }}>
              <p style={{ lineHeight: '1.3rem' }}>
                Vul een pasnummer in zonder punten. Bijv. 3120210001234. 3120 is
                al ingevuld.
              </p>
            </IonText>
          </IonItem>
