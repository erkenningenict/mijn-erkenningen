...
const DeelMetHandelaarDetailsPage: React.FC<DeelMetHandelaarDetailsPageProps> =
  () => {
    const { offline } = IsOffline.useContainer();
    const Toast = useToast();
    const { handelshuisVestigingId, persoonHandelshuisVestigingId } =
      useParams<{
    ...
    useEffect(() => {
      const persoonHandelshuisVestiging =
        personListData?.GetPersoonHandelshuisvestigingenForPersoonId?.find(
          (phv) =>
            phv.PersoonHandelshuisVestigingID ===
                ...
                <IonContent className="ion-padding">
                  <IonLabel>
                    ...
                    <p>
                      ...
                      start- en vervaldatum en type, n.a.w. gegevens). De
                      gegevens mogen uitsluitend gebruikt worden voor het
                      verifiëren van de geldigheid van uw vakbekwaamheidsbewijs.
                    </p>
                    <p>
