...
import BijeenkomstenPage from './BijeenkomstenPage';

const BijeenkomstenWrapperPage: React.FC = () => {
  ...
  return <BijeenkomstenPage />;
};

export default React.memo(BijeenkomstenWrapperPage);
