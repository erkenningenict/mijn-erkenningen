...
const WebinarDetailsPage: React.FC<BijeenkomstDetailsProps> = () => {
  ...
  const d = (data?.CursusSessies &&
    data.CursusSessies.length === 1 &&
    data.CursusSessies[0]) as CursusSessiesFieldsFragment;
      ...
      <IonHeader>
        <IonToolbar color="primary">
          <IonButtons slot="start">
            <IonBackButton defaultHref="/bijeenkomsten/webinars"></IonBackButton>
            <IonMenuButton />
          </IonButtons>
          <IonTitle>Webinar</IonTitle>
        </IonToolbar>
      </IonHeader>
            ...
            <>
              <IonCard className="welcome-card">
                ...
                <IonCardContent>
                  ...
                  {!d.Registered &&
                    data?.isLicenseValidForSpecialty.success === true && (
                      <IonButton
                        type="button"
                        expand="block"
                        className="mt-2"
